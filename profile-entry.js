...
(function(){
  ...
  function styles(){if(document.getElementById("shiftfit-profile-entry-style"))return;const s=document.createElement("style");s.id="shiftfit-profile-entry-style";s.textContent=`
      ...
      #${MODAL} .profile-photo-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:8px;}
      #${MODAL} .profile-photo-action{padding:8px 11px;border-radius:10px;border:1px solid #39466f;background:#11182d;color:#cfc7ff;font-size:12px;font-weight:800;cursor:pointer;}
      #${MODAL} .profile-photo-action.remove{color:#ffb5bf;border-color:#5a303b;}
